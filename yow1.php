...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['purchase'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO cart (product_name, quantity, total_price, username, contact_number) 
                            VALUES (?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Purchase successful!'); window.location.href='yow.php';</script>";
    } else {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a href="yow.php" class="btn-close" aria-label="Close"></a>
            </div>
